...
PROGRAMS = [
    dict(title='T&TG Coffee: From Uganda Farm to Your Cup',
         ...
         thumbnail_url='https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=600&h=340&fit=crop',
    ...
    dict(title='How to Use the T&TG Shopping Platform',
         ...
         category='ecommerce', is_active=True),
...
class Migration(migrations.Migration):
    dependencies = [('training', '0004_add_program_videos')]
