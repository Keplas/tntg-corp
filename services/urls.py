...
urlpatterns = [
    ...
    path('join/', views.join_program, name='join_program'),
    path('cooperation-program/', views.cooperation_program, name='cooperation_program'),
    ...
    path('trade/form/download/',        views.trade_form_download,   name='trade_form_download'),
]
